exports.verify = (token) => {
  return `<head>
    ...
    <title>LegalAndFinancial Email Template</title>
  ...
  background: radial-gradient(circle, rgba(47,58,147,1) 55%, rgba(244,141,48,1) 55%); border-radius: 2px; cursor: copy; font-size: 14px; padding: 6px 25px;" target="_blank">${token}</span></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
                ...
                <table style="box-sizing: border-box; width: 100%; border-spacing: 0; mso-table-rspace: 0pt; mso-table-lspace: 0pt; font-size: 12px; border-collapse: separate !important;" width="100%">
                  <tbody>
                    <tr style="font-size: 12px;">
                      <td align="center" class="align-center" style="box-sizing: border-box; font-family: 'Open Sans', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; vertical-align: top; font-size: 12px; text-align: center; padding: 20px 0;" valign="top"><span class="sg-image" style="float: none; display: block; text-align: center;"><a href="" style="box-sizing: border-box; color: #348eda; font-weight: 400; text-decoration: none; font-size: 12px;" target="_blank"><img alt="AUTOFIXZ" height="16" src="https://s3.us-east-1.amazonaws.com/cdn.carbucks.com/Group%2055.png" style="max-width: 100%; border-style: none; font-size: 12px; width: 48px; height: 48px;" width="89"></a></span>
                        ...
                        <p style="margin: 0; color: #294661; font-family: 'Open Sans', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-weight: 300; font-size: 12px; margin-bottom: 5px;">© AUTOFIXZ. Umm Ramool-Behind Dubai Duty Free Wherhouse</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
